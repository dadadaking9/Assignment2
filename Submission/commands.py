...
def edit_cmd(command): # Fix 3+ combo
   ...
   for character in command: #Not optimized / correct, fix
        ...
        if len(g.edit_requests) > 1:
                # print("added the following: (" + remaining_input[0:remaining_input.index(' ', 2)] + " : " + remaining_input[remaining_input.index(' ', 2) + 1:remaining_input.index(' -')] +")") # Delete
                ...
                # print("popped " + g.edit_requests.pop(0)) # Delete
        else: # If there is 1
                ...
                # print("added the following: (" + remaining_input[0:remaining_input.index(' ', 2)] + " : " + remaining_input[remaining_input.index(' ') + 1:] +")") # Delete
                # print("popped " + g.edit_requests.pop(0)) # Delete
